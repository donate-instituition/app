...
function LeftPanel() {
    return (
        <div className="hidden lg:block w-1/2 bg-lime-200 relative overflow-hidden min-h-[220px]">
            <svg
            ...
            >
                <path d="M0 100 Q200 200 400 100 T800 100" stroke="#A3E635" strokeWidth="3" fill="none" />
                <path d="M0 200 Q200 300 400 200 T800 200" stroke="#A3E635" strokeWidth="3" fill="none" />
                <path d="M0 300 Q200 400 400 300 T800 300" stroke="#A3E635" strokeWidth="3" fill="none" />
                <path d="M0 0 Q200 100 400 0 T800 0" stroke="#A3E635" strokeWidth="3" fill="none" />
            </svg>
            <h1 className="absolute top-10 left-10 text-4xl md:text-8xl font-bold text-[#29511C] z-10">Doe</h1>
            <p className="absolute bottom-10 left-10 max-w-[60%] text-xl md:text-2xl font-semibold text-[#29511C] z-10 break-words">
...
function SignupForm() {
    ...
    return (
        <div className="w-full md:w-1/2 p-10 flex flex-col justify-center">
            ...
            <p className="text-gray-500 text-sm mb-6">Encontre instituições que precisam da sua ajuda.</p>
            ...
            <p className="text-sm text-gray-600 mt-6 text-center">
                Já tem uma conta? <a href="/login" className="text-black font-semibold hover:underline">Entrar</a>
            </p>
        </div>
    );
}
